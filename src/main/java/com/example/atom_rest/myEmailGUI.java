...
public class myEmailGUI extends JFrame {
        ...
        newButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    Logger.getLogger(myEmailGUI.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    ...
    public static void main(String[] args) {
        SpringApplication.run(myEmailGUI.class, args);
        myEmailGUI client = new myEmailGUI();
        client.show();
